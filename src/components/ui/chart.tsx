...
>(({ id, className, children, config, scrollable = false, scrollableClassName, ...props }, ref) => {
    ...
    <ChartContext.Provider value={{ config }}>
      {scrollable ? (
        <Carousel
          ...
          className={cn("w-full h-full", scrollableClassName)}
        >
          <CarouselContent className="-ml-0 h-full">
            <CarouselItem className="min-w-0 basis-full pl-0 h-full">
              {container}
            </CarouselItem>
          </CarouselContent>
          <CarouselPrevious />
