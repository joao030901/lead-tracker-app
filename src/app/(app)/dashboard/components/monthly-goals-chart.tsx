  ...
  if (!startDate || !endDate || chartData.length === 0) {
    return (
      <Card className="h-full min-h-[300px]">
        <CardHeader>
          <CardTitle>Matrículas Mensais: Meta vs. Real</CardTitle>
          <CardDescription>Defina um período letivo.</CardDescription>
        </CardHeader>
        <CardContent className="flex items-center justify-center h-full">
          <p className="text-muted-foreground text-xs italic">Aguardando período letivo.</p>
        </CardContent>
      </Card>
    )
  }
  ...
  return (
    <Card className="h-full flex flex-col">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg">Matrículas Mensais: Meta vs. Real</CardTitle>
        <CardDescription className="text-xs">
         Recalculado proporcionalmente aos dias úteis.
        </CardDescription>
      </CardHeader>
                            ...
                            <div className="rounded-xl border bg-card p-3 text-card-foreground shadow-lg min-w-[180px]">
                                ...
                                <div className="space-y-1.5 border-t border-border pt-2 pb-2">
                                    ...
                                    <p className="flex justify-between items-center text-xs">
                                        ...
                                        <span className="font-bold text-chart-2">{data.achieved}</span>
                                    </p>
                                </div>
